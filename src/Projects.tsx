...
import hirepulse from "./assets/hirepulse.png";
...
import Neon from "./assets/techstack/neon.svg";
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
        ...
        <aside className='flex flex-col border rounded overflow-hidden h-auto w-full shadow m-auto max-w-[300px]'>
          ...
          <div className='flex flex-col ml-4 pt-2 items-start'>
            <div>
              <h5 className='text-lg font-semibold text-start'>Synapse</h5>
          ...
          <div className='flex flex-col px-2 gap-3 h-auto'>
            <p className='text-sm text-start text-muted-foreground ml-1.5 mt-2'>
              ...
              Users can post, comment like, received real time notifications and follow other users.
              Responsive to all devices with toggle dark mode functionality.
            </p>
            ...
            <div className='flex flex-wrap gap-1.5 col-span-3 my-2 ml-2 '>
              ...
              <TooltipProvider delayDuration={90} skipDelayDuration={60}>
                <Tooltip>
                  <TooltipTrigger>
                    <img src={NextJS} alt='nextjs-icon' className='w-[25px] mt-[3px]' />
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>NextJS</p>
                  </TooltipContent>
              ...
              <TooltipProvider delayDuration={90} skipDelayDuration={60}>
                <Tooltip>
                  <TooltipTrigger>
                    <img src={Neon} alt='convex-icon' className='w-[22px] mt-[3px]' />
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>Neon Database</p>
                  </TooltipContent>
            ...
            <div className='flex flex-col mb-1'>
              ...
              <a href='https://github.com/arvinbuid/synapse' className='text-xs w-full'>
              ...
              {/* live preview */}
              <a href='https://synapse-six-sand.vercel.app/' className='text-xs w-full'>
                <button className='text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-9 rounded-md px-3 mb-2 flex gap-1 items-center justify-center w-full'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    width='24'
        ...
        <aside className='flex flex-col border rounded overflow-hidden h-auto w-full shadow m-auto max-w-[300px]'>
          ...
          <div className='flex flex-col ml-4 pt-2 items-start'>
            <div>
              <h5 className='text-lg font-semibold text-start'>HirePulse</h5>
              <p className='flex items-center gap-1 text-blue-500 text-xs'>PERSONAL PROJECT</p>
            </div>
          </div>
          <div className='flex flex-col px-2 gap-3 h-auto'>
            <p className='text-sm text-start text-muted-foreground ml-1.5 mt-2'>
              A fullstack MERN application for managing and tracking job applications. Users can do
              CRUD operations & admin can manage users job application. Responsive to all devices
              with light/dark functionality.
            </p>
            ...
            <div className='flex flex-wrap gap-1.5 col-span-3 my-2 ml-2 '>
              ...
              <TooltipProvider delayDuration={90} skipDelayDuration={60}>
                <Tooltip>
                  <TooltipTrigger>
                    <img src={React} alt='react-leaflet-icon' className='w-[22px] mt-[3px]' />
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>React</p>
                  </TooltipContent>
