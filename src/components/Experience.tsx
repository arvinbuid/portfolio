...
function Experience() {
  ...
  return (
    <div id='experience' className='relative py-20 px-20 lg:px-96'>
      ...
      >
        {experienceData.map((data, index) => (
          ...
          >
            ...
            <div
              className={`hidden xl:grid w-14 absolute top-20 rounded-full z-10 bg-white aspect-square border border-gray-300 place-items-center text-red-400 font-light -translate-y-1/2 ${index % 2 === 0
